<?php
/*
 * Script initializes the BuildCompare feature preferences i.e. 
 * - which columns to use as sorting columns (when sort by needs to be used in queries)
 * - which columns to use as grouping columns (when group by needs to be used in queries)
 * depending on the selected compareby criteria
 *
 */
...
$bcC->setSortingColumns(array('tcname','tlname','tsname','extracolumn_0'));
$bcC->setGroupingColumns(array('increment','build','tsname','tlname','extracolumn_0'));
...
$bcCBy = new BuildCompareCompareByConfig();
$bcCBy->setCompareByColumn('extracolumn_3');
$bcCBy->setSortingColumns(array('tcname','tlname','tsname','extracolumn_0'));
$bcCBy->setGroupingColumns(array());
$bcCByList->setCompareByConfig($bcCBy);
...
$bcCBy->setSortingColumns(array('tlname','extracolumn_0','tsname'));
$bcCBy->setGroupingColumns(array('increment','build','tsname','tlname','extracolumn_0'));
$bcCByList->setCompareByConfig($bcCBy);
